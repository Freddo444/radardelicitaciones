    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
        ...
        <li>
            ...
            <ul role="list" class="-mx-2 mt-2 space-y-1">
                <li>
                    <a href="#"
                       class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-blue-200/50 cursor-not-allowed">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true" class="size-6 shrink-0 text-blue-200/50">
                    ...
                    <a href="#"
                       class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-blue-200 hover:bg-blue-900 hover:text-white">
                        <span class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-blue-400 bg-blue-700 text-[0.625rem] font-medium text-white">
                            {{ strtoupper(substr(\App\Models\Setting::get('empresa_nombre', 'E'), 0, 1)) }}
                        </span>
                        <span class="truncate">{{ \App\Models\Setting::get('empresa_nombre', 'Sin configurar') }}</span>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul role="list" class="-mx-2 space-y-1">
                <li>
                    <form method="POST" action="{{ route('poll.manual') }}">
                        @csrf
                        <button type="submit"
                                class="group flex w-full gap-x-3 rounded-md bg-blue-700 p-2 text-sm/6 font-semibold text-white hover:bg-blue-600">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true" class="size-6 shrink-0 text-white">
