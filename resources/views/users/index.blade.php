...
<div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">{{ $users->count() }} usuario{{ $users->count() !== 1 ? 's' : '' }} con acceso al sistema.</p>
        </div>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr class="even:bg-gray-50">
                            <td class="py-4 pr-3 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 sm:pl-3">
                                {{ $user->name }}
                                @if($user->id === auth()->id())
                                    <span class="ml-2 inline-flex items-center rounded-md bg-indigo-50 px-1.5 py-0.5 text-xs font-medium text-indigo-700">tú</span>
                                @endif
                            </td>
                            ...
                            <td class="py-4 pr-4 pl-3 text-right text-sm whitespace-nowrap sm:pr-3">
                                <div class="flex items-center justify-end gap-x-1">
                                    ...
                                    <button type="button"
                                            ...
                                            class="rounded-md p-1 text-gray-400 hover:text-indigo-600">
