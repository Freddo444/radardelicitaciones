...
<section class="pt-28 pb-20 sm:pt-40 sm:pb-32">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <h1 class="font-display text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">Política de privacidad</h1>
        ...
        <div class="prose prose-zinc mt-10 max-w-none text-sm leading-6 prose-a:text-indigo-600 prose-a:no-underline hover:prose-a:underline sm:leading-7">
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">1. Información que recopilamos</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">2. Cómo usamos su información</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">3. Almacenamiento y seguridad</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">4. Compartición de datos</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">5. Aislamiento entre empresas</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">6. Retención de datos</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">7. Sus derechos</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">8. Cookies</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">9. Cambios a esta política</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-zinc-900">10. Contacto</h2>
