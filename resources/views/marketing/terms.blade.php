...
<section class="pt-32 pb-24 sm:pt-40 sm:pb-32">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <h1 class="font-display text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Términos de servicio</h1>
        ...
        <div class="prose prose-gray mt-10 max-w-none text-sm leading-7">
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">1. Aceptación de los términos</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">2. Descripción del servicio</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">3. Registro y cuentas</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">4. Planes y precios</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">5. Pagos y facturación</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">6. Cancelación</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">7. Uso aceptable</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">8. Propiedad intelectual</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">9. Limitación de responsabilidad</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">10. Disponibilidad del servicio</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">11. Modificaciones</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">12. Ley aplicable</h2>
            ...
            <h2 class="font-display text-lg font-semibold text-gray-900">13. Contacto</h2>
