    ...
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 divide-y divide-zinc-200" x-data="{ open: null }">
            ...
            $faqs = [
                ...
                ['¿Cómo funciona el pago?', 'Aceptamos PayPal para pagos recurrentes automáticos, tarjeta vía Azul (Página de Pagos, en pesos dominicanos según el tipo de cambio USD/DOP que fija el administrador en el panel /admin) y transferencia bancaria para pagos manuales. Con transferencia, sube su comprobante y lo confirmamos en horas laborables.'],
