...
<section class="pt-32 pb-24 sm:pt-40 sm:pb-32">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center" data-animate>
            <p class="font-display text-sm font-semibold text-emerald-600">Precios</p>
            <h1 class="font-display mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            ...
            <div class="rounded-3xl bg-white p-6 shadow-xl ring-1 ring-gray-200 sm:p-8 md:p-10">
                ...
                <div class="mt-8 space-y-6">
                    <div>
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="font-display font-semibold text-gray-900" x-text="companies"></span>
                        </div>
                        <input type="range" min="1" max="5" x-model="companies"
                               class="mt-2 w-full accent-emerald-500 cursor-pointer">
                        <div class="mt-1 flex justify-between text-xs text-gray-400"><span>1</span><span>5</span></div>
                    </div>
                    <div>
                        <div class="flex items-center justify-between text-sm">
                            <label class="font-medium text-gray-700">Usuarios</label>
                            <span class="font-display font-semibold text-gray-900" x-text="users"></span>
                        </div>
                        <input type="range" min="2" max="15" x-model="users"
                               class="mt-2 w-full accent-emerald-500 cursor-pointer">
                        <div class="mt-1 flex justify-between text-xs text-gray-400"><span>2</span><span>15</span></div>
                    </div>
                </div>
                ...
                <ul class="mt-8 space-y-3 text-sm text-gray-600">
                    ...
                    <li class="flex items-start gap-3">
                        <svg class="mt-0.5 size-5 shrink-0 text-emerald-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div data-animate class="mx-auto mt-12 max-w-lg text-center">
            ...
            <div class="mt-3 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-xs text-gray-500 sm:text-sm">
                ...
                <span class="flex items-center gap-1.5">
                    <svg class="size-5 text-gray-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21"/></svg>
