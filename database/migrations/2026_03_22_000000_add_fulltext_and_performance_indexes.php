...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('awarded_articles', function (Blueprint $table) use ($sqlite) {
            if (! $sqlite) {
                $table->fullText(
        ...
        Schema::table('contracts', function (Blueprint $table) use ($sqlite) {
            if (! $sqlite) {
                $table->fullText(
        ...
        Schema::table('pacc_acquisitions', function (Blueprint $table) use ($sqlite) {
            if (! $sqlite) {
                $table->fullText(
        ...
        Schema::table('providers', function (Blueprint $table) use ($sqlite) {
            if (! $sqlite) {
                $table->fullText(
        ...
        Schema::table('institutions', function (Blueprint $table) use ($sqlite) {
            if (! $sqlite) {
                $table->fullText(
